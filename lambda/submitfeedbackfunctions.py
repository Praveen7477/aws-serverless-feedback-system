...
TABLE_NAME = os.environ.get('TABLE_NAME', 'feedback-praveen').strip() # DynamoDB Table name for storing feedback
BUCKET_NAME = os.environ.get('BUCKET_NAME', 'praveen-2026-v1')  # S3 bucket name for storing feedback attachments
ADMIN_EMAIL = os.environ.get('ADMIN_EMAIL', 'praveenpandarinathan@gmail.com')  # Admin email to receive notifications
